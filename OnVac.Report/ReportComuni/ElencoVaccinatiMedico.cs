namespace Onit.OnAssistnet.OnVac.Report.ReportComuni
{
    ...
    /// </summary>
    public partial class ElencoVaccinatiMedico : Telerik.Reporting.Report
    {
        ...
        {
            string result = @"Elenco vaccinati {0} {1}
...
{8}";
        ...
        private void groupHeaderSection1_ItemDataBound(object sender, EventArgs e)
        {
            ...
            //    groupTotal = (((Telerik.Reporting.Processing.ReportItemBase)(processingSection)).ItemDefinition).Items.Count;
            //}
            //groupCount++;
        }
