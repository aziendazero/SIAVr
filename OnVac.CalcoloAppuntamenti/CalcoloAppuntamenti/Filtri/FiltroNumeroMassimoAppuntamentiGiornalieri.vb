Namespace Filtri
    <Serializable()> _
    Public Class FiltroNumeroMassimoAppuntamentiGiornalieri
        Implements IFiltro
        ...
        Public Function ApplicaMarcher(ByVal giorni As Timing.DayCollection, ByVal pars As Hashtable) As Timing.DayCollection Implements IFiltro.ApplicaMarcher
            ...
            If Not pars(NumeroMassimoPrenotatiGiornaliero) Is Nothing Then
                For Each d As Timing.Day In giorni
                    If Not d.Full Then
                        ...
                        If conteggio >= pars(NumeroMassimoPrenotatiGiornaliero) Then
                            For Each t As Timing.TimeBlock In d.TimeBlocks
        ...
        Public Shared NumeroMassimoPrenotatiGiornaliero As String = "NumeroMassimoPrenotatiGiornaliero"

        Public ReadOnly Property GetMotivoRifiuto() As MotiviRifiuto.IMotivoRifiuto Implements IFiltro.GetMotivoRifiuto
            Get
                Return New MotiviRifiuto.RifiutoMassimoNumero("Massimo prenotati")
            End Get
        End Property
    End Class
End Namespace
