...
Partial Public Class StatVaccinazioniGiornaliere
    ...
    '''<summary>
    '''Controllo chklVaccinazioni.
    '''</summary>
    '''<remarks>
    '''Campo generato automaticamente.
    '''Per la modifica, spostare la dichiarazione di campo dal file di progettazione al file code-behind.
    '''</remarks>
    Protected WithEvents chklVaccinazioni As Global.System.Web.UI.WebControls.CheckBoxList
    
    '''<summary>
    '''Controllo chkFittizia.
    '''</summary>
    '''<remarks>
    '''Campo generato automaticamente.
    '''Per la modifica, spostare la dichiarazione di campo dal file di progettazione al file code-behind.
