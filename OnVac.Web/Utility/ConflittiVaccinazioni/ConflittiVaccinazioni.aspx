<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConflittiVaccinazioni.aspx.vb" Inherits="Onit.OnAssistnet.OnVac.ConflittiVaccinazioni" %>
...
<html>
<head>
    <title>Conflitti Vaccinazioni</title>
    ...
    <script type="text/javascript">
        askConfirmReazioniAvverse = true;
    </script>

</head>
<body>
    <form id="form1" runat="server">
        <on_lay3:OnitLayout3 ID="OnitLayout31" runat="server" Height="100%" Width="100%" TitleCssClass="Title3" Titolo="Risoluzione Conflitti Vaccinazioni">
                        
            <div class="title" id="PanelTitolo" runat="server" style="width: 100%;">
			    <asp:Label id="LayoutTitolo" runat="server">&nbsp;Risoluzione Conflitti Vaccinazioni</asp:Label>
			</div>
            <div>
            ...
            <dyp:DynamicPanel ID="dypScroll" runat="server" Width="100%" Height="100%" ScrollBars="Auto" RememberScrollPosition="true">
                ...
                <asp:DataGrid id="dgrConflitti" runat="server" Width="100%" AutoGenerateColumns="False" AllowCustomPaging="true" AllowPaging="true" PageSize="25" >
					...
					<Columns>
					    ...
					    <asp:TemplateColumn Visible="false">
					        <ItemTemplate>
					            <asp:Label ID="lblIdVaccinazioneEseguitaCentrale" runat="server" Text='<%# Eval("IdVaccinazioneEseguitaCentrale") %>' ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
					    ...
					    <asp:TemplateColumn HeaderText="Vaccinazioni in conflitto" >
								...
								<div id="divDettaglio" name="divDettaglio" style="display: none; margin-top: 2px; margin-bottom: 2px;">
								    ...
								    <asp:DataGrid id="dgrDettaglio" runat="server" Width="100%" CssClass="datagridDettaglio" AutoGenerateColumns="False" >
										...
										<Columns>
					                        <asp:TemplateColumn Visible="false">
					                            <ItemTemplate>
					                                <asp:Label ID="lblIdVaccinazioneCentrale" runat="server" Text='<%# Eval("Id") %>' ></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
					                        <asp:TemplateColumn Visible="false">
					                            <ItemTemplate>
					                                <asp:Label ID="lblIdVaccinazioneLocale" runat="server" Text='<%# Eval("IdVaccinazioneEseguita") %>' ></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
					                        <asp:TemplateColumn Visible="false">
					                            <ItemTemplate>
					                        ...
					                        <asp:TemplateColumn HeaderText="Data Esecuzione" >
                                                <HeaderStyle Width="13%" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" />
					                            <ItemTemplate>
					                                <asp:Label ID="lblDataEffettuazione" runat="server" Text='<%# BindDateField(Eval("DataEffettuazione")) %>' ></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
					                        <asp:TemplateColumn HeaderText="Ass. [Dose]">
                                                <HeaderStyle Width="15%" />
					                            <ItemTemplate>
					                                <asp:Label ID="lblAssociazione" runat="server" Text='<%# String.Format("{0} [{1}]", Eval("CodiceAssociazione"), Eval("DoseAssociazione")) %>' ></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
					                        <asp:TemplateColumn HeaderText="Vacc. [Dose]">
                                                <HeaderStyle Width="15%" />
					                            <ItemTemplate>
					                                <asp:Label ID="lblVaccinazione" runat="server" Text='<%# String.Format("{0} [{1}]", Eval("CodiceVaccinazione"), Eval("DoseVaccinazione")) %>' ></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
					                        <asp:TemplateColumn HeaderText="Nome Commerciale">
                                                <HeaderStyle Width="15%" />
					                            <ItemTemplate>
					                                <asp:Label ID="lblCodiceNomeCommerciale" runat="server" Text='<%# Eval("CodiceNomeCommerciale") %>' ></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
					                        <asp:TemplateColumn HeaderText="Lotto">
                                                <HeaderStyle Width="13%" />
					                            <ItemTemplate>
					                                <asp:Label ID="lblCodiceLotto" runat="server" Text='<%# Eval("CodiceLotto") %>' ></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn HeaderText="Azienda">
                                                <HeaderStyle Width="8%" />
					                            <ItemTemplate>
					                                <asp:Label ID="lblCodiceUslVaccinazioneEseguita" runat="server" Text='<%# Eval("CodiceUslVaccinazioneEseguita") %>' ></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn HeaderText="Reaz.">
                                                <HeaderStyle Width="5%" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" />
					                            <ItemTemplate>
                                                    <asp:Image ID="imgReazioneAvversa" runat="server" ImageAlign="Middle" />
                                                    <asp:HiddenField ID="hdIdReazioneAvversa" runat="server" Value='<%# Eval("IdReazioneAvversa") %>' />
                                                    <asp:HiddenField ID="hdTipoReazioneAvversa" runat="server" Value='<%# Eval("TipoReazioneAvversa") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn HeaderText="Stato" >
                                                ...
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Image ID="imgTipoVaccinazioneEseguitaCentrale" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
										</Columns>
									</asp:DataGrid>
