<%@ Control Language="vb" AutoEventWireup="false" Codebehind="InsRifiuto.ascx.vb" Inherits="Onit.OnAssistnet.OnVac.InsRifiuto" %>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" height="222">
    ...
    <tr>
        <td>
          <div id="divLayTit_Sez" class="sezione" style="">
	...
	<tr style="height:200px">
		<td>
			<div style="overflow:auto;width:100%;height:200px">
				...
				<asp:datagrid id="dg_vac" runat="server" CssClass="DATAGRID" Width="100%" AutoGenerateColumns="False" CellPadding="1" GridLines="None">
