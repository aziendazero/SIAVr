<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InfoAssociazioni.aspx.vb" Inherits="Onit.OnAssistnet.OnVac.InfoAssociazioni" ValidateRequest="false" %>
...
<head runat="server">
    <title>Informazioni sulle associazioni</title>
...
<body>
    <form id="form1" runat="server">
        <on_lay3:OnitLayout3 ID="OnitLayout31" runat="server" Height="100%" Width="100%" TitleCssClass="Title3" Titolo="Informazioni sulle associazioni">
