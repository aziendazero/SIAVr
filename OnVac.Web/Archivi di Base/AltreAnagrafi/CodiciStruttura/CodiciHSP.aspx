<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CodiciHSP.aspx.vb" Inherits="Onit.OnAssistnet.OnVac.CodiciHSP" %>
...
<body>
    <form id="form1" runat="server">
       <on_lay3:onitlayout3 id="OnitLayout31" runat="server" width="100%" height="100%" TitleCssClass="Title3" Titolo="Codici HSP">
            <div>
            ...
            <dyp:DynamicPanel ID="dypScroll" runat="server" Width="100%" Height="30%" ScrollBars="Auto" RememberScrollPosition="true" DynamicHeight="58%">
                <asp:DataGrid ID="dgrCodiciHsp" runat="server" Width="100%" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="CodiceHsp" HeaderText="Codice" HeaderStyle-Width="12%"></asp:BoundColumn>
                    ...
                    <tr>
                        ...
                        <td>
                            <on_ofm:OnitModalList id="omlAsl" runat="server" PosizionamentoFacile="False" LabelWidth="-1px"
							    Width="70%" CodiceWidth="30%" CampoCodice="USL_CODICE" CampoDescrizione="USL_DESCRIZIONE"
							    Tabella="T_ANA_USL" UseCode="True" Obbligatorio="False" SetUpperCase="True"></on_ofm:OnitModalList>
                        </td>
                        <td class="label">Comune</td>
                        <td>
						    <on_ofm:onitmodallist id="omlComune" runat="server" PosizionamentoFacile="False" LabelWidth="-8px"
                                Width="70%" CodiceWidth="30%" CampoCodice="COM_CODICE" CampoDescrizione="COM_DESCRIZIONE"
							    Tabella="T_ANA_COMUNI" UseCode="True" Obbligatorio="False" SetUpperCase="True"></on_ofm:onitmodallist>
                        </td>                     
                    </tr>
                    <tr>
